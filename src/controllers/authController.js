...
class authController {
  ...
  static async signUp(req, res) {
    const {
      email, first_name, last_name, password, phone, address, city, state, country, postal_code, profile_picture,
      dob, international_passport_no, drivers_lisence, car_brand,
    } = req.body;
